...
import am.developer.labels.ProjectLabels;
import am.developer.nodes.User;
...
public class UserDAO {
    ...
    public UserDAO(GraphDatabaseService graphDb) {
    ...
    public List<User> findAll() {
        Result result = graphDb.execute("MATCH (e:User) RETURN e");
